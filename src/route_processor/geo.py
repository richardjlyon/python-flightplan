...
RADIUS_OF_EARTH = 3440.065  # Earth's radius in nautical miles
...
class Segment:
    ...
    def __init__(self, start: Waypoint, end: Waypoint) -> None:
    ...
    def length(self) -> float:
        ...
        return RADIUS_OF_EARTH * math.sqrt(x * x + dlat * dlat)
